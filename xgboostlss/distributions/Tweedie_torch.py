...
class TweedieTorch(TorchDistribution):
    ...
    arg_constraints =  {
        ...
        "power": constraints.positive  ## should be between [1, 2]
    }
    support = constraints
    has_rsample = True
    ...
    def expand(self, batch_shape, _instance = None):
        # expand to the shape of batch_shape?
        # what is this instance for?
        new = self._get_checked_instance(TweedieTorch, _instance)
...
class Tweedie(DistributionClass):
    """
    Tweedie implemented as XGBoostLSS distribution class
    .....? scale???
    """
    """
    Parameters
